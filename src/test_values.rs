...
pub fn node_map() -> std::collections::HashMap<String, node::Info> {
    ...
    let node1 = node::Info {
        ...
        private_key: Some("EKEigSUES3iGHmKJNMMHVVhQmoiV5gWGXwvkMzQtE6rVnAauex4Y".to_string()),
        node_type: node::Type::Archive,
    };
    let node2 = node::Info {
        graphql_uri: Some("node2/graphql".to_string()),
        private_key: Some("EKEU3eCHwY5sj2VVH5RXSNQddCpK26aUgCqxXEg9JkkqVeE3XGLu".to_string()),
        node_type: node::Type::BlockProducer,
    };
    let node3 = node::Info {
        graphql_uri: Some("node3/graphql".to_string()),
        private_key: Some("EKEXjtu5y3N3VoBtDF8iuaYrrcB7arjsVEjnbcBRH7ZEL5k3odK9".to_string()),
        node_type: node::Type::Seed,
    };
    let node4 = node::Info {
        graphql_uri: Some("node4/graphql".to_string()),
        private_key: Some("EKEiAqExT3sNGYA4Lp6ZPfqfACYJSkTNAVzsHj7Qkzw59A5BsZGH".to_string()),
